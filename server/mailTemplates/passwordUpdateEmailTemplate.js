export const passwordUpdated = (name, resetDate) => {
    return `<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        ...
        <p>Your password for your Auratime account has been successfully updated. If you made this change, no further action is required.</p>
