...
const Home = () => {
  return (
    <>
      <div className='relative bg-[url("/img/bg1.jpg")] bg-center h-[calc(100vh-50px)] font-manrope text-[#CBBA9C]'>
      <div className="absolute flex lg:hidden inset-0 bg-black opacity-60"></div>

        <div className='relative w-full md:w-3/5 px-10 xl:w-1/2 xl:px-32 flex flex-col gap-4 justify-center h-full'>
          ...
          <Link to={'/login'} className='w-1/2 xxs:w-1/3'><button className='w-full py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500'>Get Started</button></Link>
        </div>
      </div>
      ...
      <div className='flex flex-col lg:flex-row lg:h-[80vh] font-manrope'>
        <div className='w-full lg:w-1/2 bg-[url("/img/bg2.jpg")] bg-cover bg-center flex flex-col gap-3 p-20 justify-end opacity-100  hover:opacity-95'>
          ...
          <Link to={'/login'} className='xl:w-1/5 xs:w-2/5 w-3/5'><button className='w-full py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500'>BUY NOW</button></Link>
        </div>
        <div className='w-full lg:w-1/2'>
          ...
          <div className='bg-[url("/img/bg5.jpg")] bg-cover bg-center h-1/2 w-full opacity-100 hover:opacity-95 flex flex-col gap-3 p-10 text-right'>
            ...
            <div className='w-full  flex justify-end'><div className='w-2/3 xs:w-2/5 xxs:w-3/5 py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500 text-center'><Link to={'/login'} >VIEW COLLECTIONS</Link></div></div>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col md:flex-row md:h-[70vh]'>
        <div className='w-full md:w-[42vw] flex flex-col gap-3 bg-[url("/img/img1.png")] bg-no-repeat bg-left-bottom py-12 xl:py-32 px-12 pl-10 xl:pl-32 bg-[#dadcde]'>
          ...
          <span><Link to={'/login'} className='inline-flex gap-3 items-center'><IoIosArrowRoundBack className='text-[25px]' />View All Categories</Link></span>
        </div>
      ...
      <div className='flex flex-col md:flex-row md:h-[60vh]'>
        ...
        <div className='w-full md:w-[55vw] flex bg-[url("/img/img3.webp")] bg-no-repeat bg-right-top bg-[#dadcde] px-8'>
          <div className='w-4/5 xl:w-1/2 py-10 flex flex-col gap-3'>
            ...
            <Link to={'/login'} className='w-1/2 xs:w-1/3'><button className='w-full py-2 border-2 bg-[#777777] text-white font-bold hover:bg-transparent hover:text-black hover:border-black transition-all duration-500'>Show More</button></Link>
          </div>
