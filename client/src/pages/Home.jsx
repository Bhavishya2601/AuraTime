    ...
    <>
      <div className='bg-[url("img/bg1.jpg")] bg-center h-[calc(100vh-50px)] font-manrope text-[#CBBA9C]'>
        <div className='w-1/2 px-32 flex flex-col gap-4 justify-center h-full'>
          ...
          <button className='w-1/3 py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500'><Link to={'/login'}>Get Started</Link></button>
        </div>
      </div>
      ...
      <div className='flex h-[80vh] font-manrope'>
        <div className='w-1/2 bg-[url("img/bg2.jpg")] bg-cover bg-center flex flex-col gap-3 p-20 justify-end opacity-100  hover:opacity-95'>
          ...
          <button className='w-1/5 py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500'><Link to={'/login'}>BUY NOW</Link></button>
        </div>
        <div className='w-1/2'>
          <div className='h-1/2 flex'>
            <div className='w-1/2 bg-[url("img/bg3.jpg")] bg-center bg-cover opacity-100 hover:opacity-95 flex flex-col gap-3 justify-center items-center'>
              ...
              <button className='w-1/3 py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500 items-end'><Link to={'/login'}>BUY NOW</Link></button>
            </div>
            <div className='w-1/2 bg-[url("img/bg4.png")] bg-center opacity-100 hover:opacity-90 flex flex-col gap-3 justify-center items-center'>
              ...
              <button className='w-1/3 py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500 items-end'><Link to={'/login'}>VIEW ALL</Link></button>
            </div>
          </div>
          <div className='bg-[url("img/bg5.jpg")] h-1/2 w-full bg-center opacity-100 hover:opacity-95 flex flex-col gap-3 p-10 text-right'>
            ...
            <div className='w-full'><button className='w-1/3 py-2 border-[#CBBA9C] border-2 font-bold hover:bg-[#CBBA9C] text-white transition-all duration-500 items-end'><Link to={'/login'}>VIEW COLLECTIONS</Link></button></div>
          </div>
        </div>
      </div>
      ...
      <div className='flex h-[60vh]'>
        ...
        <div className='w-[55vw] flex bg-[url("img/img3.webp")] bg-no-repeat bg-right-top bg-[#dadcde] px-8'>
          <div className='w-1/2 py-10 flex flex-col gap-3'>
            ...
            <button className='w-1/3 py-2 border-2 bg-[#777777] text-white font-bold hover:bg-transparent hover:text-black hover:border-black transition-all duration-500'><Link to={'/login'}>Show More</Link></button>
          </div>
